...
@Component({
  selector: 'app-institute-master-list',
  standalone: false,
  templateUrl: './institute-master-list.html',
  styleUrl: './institute-master-list.css',
})
export class InstituteMasterList implements OnInit {
